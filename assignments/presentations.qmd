...
Please review the [class schedule](../schedule/) and select four papers (or groups of papers) from the list of papers from each class. Focus only on the Part I, Part II, or Part III classes in each section (i.e., do not select any papers listed solely as background). Your selections must also be on different dates. Once you've identified your papers, note your paper title, authors, your name, and the date of your presentation on the **Presentations** tab of the Google Sheet [here](https://docs.google.com/spreadsheets/d/19LovendEZg3Qk_5Wgy-we_9owO8sPnseU5blbik86MI/edit?usp=sharing) no later than **Friday, January 26**.

We will have no more than four paper groupings per class day, which means we have to keep each presentation plus discussion to no more than 20 minutes. We'll have a few extra minutes on days with just three paper groupings, but even on those days, let's aim for 20 minutes. The presentation should follow a standard conference setup, with some brief discussion of the research question, discussion of the data, empirical analysis, and results and key contributions. You should also prepare two discussion questions to lead a 5 minute discussion after your presentation. Please submit your presentations via **Canvas** no later than **11:59pm on the day before your presentation**.
...
- Presentation "quality": the presentation should be clear and well-organized, with a clear description of the research question, data, empirical analysis, and results
- Presentation length: the presentation should be no more than 15 minutes, including clarifying questions
